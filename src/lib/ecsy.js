(function(exports){
  ...
  let ECSY = {};
  ECSY.Component = Component;
	ECSY.Not = Not;
	ECSY.System = System;
	ECSY.SystemStateComponent = SystemStateComponent;
	ECSY.TagComponent = TagComponent;
	ECSY.Types = Types;
	ECSY.World = World;
	ECSY.createComponentClass = createComponentClass;
	ECSY.createType = createType;
